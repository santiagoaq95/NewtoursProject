...
public class TestLoginOnInternetExplorer {
	...
	public void setUp() throws Exception {
		...
		loginPageNewtours.launcheBrowser("ie");
	...
	public void test() throws IOException {
		...
		loginPageNewtours.loginToNewtours(username.get(0), password.get(1));
		screenshot.TakeScreenshot(loginPageNewtours.getNavegadorDriver(), "testIE");
		loginPageNewtours.clickOnLoginButton();
		screenshot.TakeScreenshot(loginPageNewtours.getNavegadorDriver(), "testIEResult");
	}
