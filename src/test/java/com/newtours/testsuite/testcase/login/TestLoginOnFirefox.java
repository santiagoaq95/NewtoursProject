...
public class TestLoginOnFirefox {
	...
	public void setUp() throws Exception {
		...
		loginPageNewtours.launcheBrowser("firefox");
	...
	public void test() throws IOException {
		...
		loginPageNewtours.loginToNewtours(username.get(1), password.get(1));
		screenshot.TakeScreenshot(loginPageNewtours.getNavegadorDriver(), "testFirefox");
		loginPageNewtours.clickOnLoginButton();
		screenshot.TakeScreenshot(loginPageNewtours.getNavegadorDriver(), "testFirefoxResult");
	}
